...
Реальные показатели акимата и Smart Astana вместо синтетики, калибровка весов, многопериодная симуляция с переносом бюджета, городские события (шоки бюджета и показателей), лидерборд команд, интеграция с eGov, RU/KZ интерфейс (казахские названия районов уже в данных).
