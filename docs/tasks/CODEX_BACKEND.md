...
> Внутреннее задание исполнителя на время хакатона (разработка велась двумя AI-агентами по общему контракту). Контракт API и правила расчёта — разделы 4, 5, 7 файла `CODEX_BACKEND.md`; актуальная документация — `README.md` и `docs/ARCHITECTURE.md`.
